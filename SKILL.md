...
> 本 skill 附两份「描述（使用说明）」文档，内容与用户原始附件**完全一致、未作编辑或删减**，涵盖产品目标、功能演进（v1→v19）、8 大模块用法、部署与移动端验收，以及完整使用指南。

> 文件位置（按需读取，避免 SKILL.md 臃肿）：
> - `references/v19-source/docs/开发日志-对外版.md`
> - `references/v19-source/docs/使用说明.md`
